class snake {
  ...
  NeuralNetwork brain = new NeuralNetwork(6, 8, 2);  //6 input nodes for 2 for x and y pos of closest food and 2 for snakes heads x and y pos
  ...
  void doPredictedMovement(ArrayList<food> f){
    ...
    brain.inputs.matrix[2][0] = height -y;
    brain.inputs.matrix[3][0] = width - x;
    brain.inputs.matrix[4][0] = fi.x; 
    brain.inputs.matrix[5][0] = fi.y; 
